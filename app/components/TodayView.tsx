            ...
            >
              ...
              <div className="mt-3 grid grid-cols-[1fr_auto_auto] items-center gap-2">
                ...
                <button
                  ...
                  className="flex h-9 w-9 items-center justify-center rounded-xl border border-red-500/30 bg-red-500/10 text-red-400 transition hover:bg-red-600/20 disabled:opacity-60"
